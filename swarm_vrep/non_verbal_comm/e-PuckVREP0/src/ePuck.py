...
#
# Just: "${PATH_TO_BINARY}/ePuck --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	adapter = ic.createObjectAdapter('Camera')
	adapter.add(CameraI(worker), ic.stringToIdentity('camera'))
	adapter.activate()
